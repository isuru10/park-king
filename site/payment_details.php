    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Payment
                    <small>confirm your payment</small>
                </h1>
                <ol class="breadcrumb">
...
<!--                <dd id="res_time">--><?//= $_POST['res-time']?><!--</dd>-->
                        <dt>Time:</dt>
                        <dd><span id="time"><?= $_GET['time']?></span> mins</dd>

                        <dt>Amount:</dt>
                        <dd><span id="amount"><?= $_GET['amount']?></span> LKR</dd>

                        <dt>Reservation ID:</dt>
                        <dd id="res_id"><?= $_GET['resId']?></dd>

                        <dt>Plate No:</dt>
                        <dd id="res_id"><?= $_GET['plateNo']?></dd>
    ...
    <script>
        $("#btnConfirm").click(function () {
            ...
            $.post("../controller/payment-controller.php", data, function (res) {
                console.log(res);
