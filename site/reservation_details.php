...
if(!isset($_SESSION['exists'])){
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Home
                    <small>Confirm your reservation</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content container-fluid">
                ...
                <div class="register-box-body">
                    <p class="login-box-msg">Reservation Details</p>

                    <dl class="dl-horizontal">
                        <dt>Plate no:</dt>
                        <dd id="plate_no"><?= $_POST['plate_no']?></dd>
                <dt>Parking lot ID:</dt>
                <dd id="lot_id"><?= $_POST['lot_id']?></dd>
                        <dt>slot ID:</dt>
                        <dd id="slot_id"><?= $_POST['slot_id']?></dd>
                <dt>Parking space location:</dt>
                <dd id="address"><?= $_SESSION['address']?></dd>
                        <dt>Parking space name:</dt>
                        <dd id="address"><?= $_SESSION['name']?></dd>
                <dt>Reservation time:</dt>
                <dd id="res_time"><?= $_POST['res-time']?></dd>
                        <dt>End time:</dt>
                        <dd id="end_time"><?= $_POST['end-time']?></dd>
                        <dt>Amount:</dt>
                        <dd id="end_time"><?= $_POST['amount']?></dd>
                          ...
                          <div>
                            <div class="col-xs-4">
                                <button type="button " class="btn btn-primary btn-block btn-flat" id="btnConfirm">Confirm</button>
                            </div>
                            <div class="col-xs-4">
                                <button type="button" class="btn btn-block btn-danger btn-flat" id="btnDiscard">Discard</button>
                            </div>
                        </div>
    ...
    <script>
        $("#btnConfirm").click(function () {
            ...
            var lot_id = $("#lot_id").text()
            var plate_no = $("#plate_no").text()
            var slot_id  = $("#slot_id").text()
            var data = {
                'res-time': res_time,
                'end-time': end_time,
                'lot_id': lot_id,
            ...
            $.post("../controller/reservation-controller.php", data, function (res) {
                console.log(res);
