    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Home
                    <small>Cancellation of your reservation</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content container-fluid">
                ...
                <div class="register-box-body">
                    <label> Your reservation has been cancelled!</label>
                          ...
                          <div>
                            <div class="col-xs-4">
                                <button type="button " class="btn btn-primary btn-block btn-flat" id="btnConfirm">Done</button>
                            </div>
