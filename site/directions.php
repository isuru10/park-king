...
if(!isset($_SESSION['exists'])){
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Directions
                    <small>follow the directions to parking lot</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content container-fluid">
                ...
                <div class="box box-default">
                    <div class="box-body">
                        ...
                        <input type="text" name="dest_lat" id="dest_lat" style="display: none" value="<?=$_GET["dest_lat"]?>">
                        <input type="text" name="dest_lng" id="dest_lng" style="display: none" value="<?=$_GET["dest_lng"]?>">
                        <input type="text" name="res_id" id="res_id" style="display: none" value="<?=$_GET["res_id"]?>">
                        <input type="text" name="slot_id" id="slot_id" style="display: none" value="<?=$_GET["slot_id"]?>">
                    </div>
                    <div class="box-footer">
                        <button type="button" class="btn btn-danger pull-right" id="btnCancel">Cancel Trip</button>
                    </div>
                </div>
            </section>
            <!-- /.content -->
    ...
    <script src="dist/js/directions.js"></script>
...
<!--    &key=AIzaSyD_zRDfwHDsB4wTQ1fe3iz4eMA1XMXQadg-->
