                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-warning">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form id="itemForm" action="../../../controller/item-controller.php" method="post"
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <button id="btnAllItem" type="button" class="btn btn-primary">View All
                                                Item
                                            </button>
                                            <button id="btnDeleteItem" type="reset" class="btn btn-danger">Delete
                                            </button>
