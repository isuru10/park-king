            ...
            <section class="content container-fluid">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="../controller/reservation-controller.php" method="post" id="form">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="res_id" name="res_id">
                            </div>
                            <div class="form-group">
                                <label>Reservation Time:</label>

                                <div class="input-group">
                                    <input type="text" class="form-control bootstrap-timepicker" name="res-time" id="res-time">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control bootstrap-timepicker" name="end-time" id="end-time">
                            ...
                            <div class="form-group">
                                <label for="lot_id">Slot ID</label>
                                <input type="text" class="form-control" id="slot_id" placeholder="Slot ID">
                    ...
                    <div class="box-footer">
                        <input type="button" class="btn btn-success pull-right" id="btnCheckIn" value="Check in">
                        <input type="button" class="btn btn-primary" id="btnCheckOut" value="Check Out">
                    </div>
                    </form>
                </div>
                <div class="box box-primary">
                    <div class="box-header with-border">
                    <h4 class= "box-title">Reservation Table</h4>
                    </div>
                    <div class="box-body">
                    <table class="table table-bordered" id="tableOrder">
                                <thead>
                                    <tr>
                                        <th style="width: 15px">Res. ID</th>
                                        <th style="width: 20px">Res. Time</th>
                                        <th style="width: 20px">End Time</th>
                                        <th style="width: 15px">Slot ID</th>
                                        <th style="width: 15px">Plate No.</th>
                                        <th>Status</th>
                                    </tr>
                                </thead>
                        <tbody>
                    ...
                    <input type="text" name="" id="plate_no" style="display: none">
